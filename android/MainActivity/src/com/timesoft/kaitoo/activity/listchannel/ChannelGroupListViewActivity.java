...
import com.timesoft.kaitoo.adapter.ChannelGroupListViewAdapter;
...
import com.timesoft.kaitoo.customized.listview.ChannelGroupListViewTask;

public class ChannelGroupListViewActivity extends MainAppActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ChannelGroupListViewTask task = new ChannelGroupListViewTask(activity);
		taskManager.executeTask(task, ChannelGroupListViewTask.createRequest(URL),
