...
public class ChannelGroupListViewAdapter extends BaseAdapter {
	...
	public ChannelGroupListViewAdapter(Activity a,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		groupName.setText(group.get(ChannelGroupListViewActivity.KEY_TITLE));
		// duration.setText(song.get(CustomizedListViewActivity.KEY_DURATION));
		imageLoader
				.DisplayImage(
						group.get(ChannelGroupListViewActivity.KEY_THUMB_URL),
						groupImage);
		return vi;
	}
